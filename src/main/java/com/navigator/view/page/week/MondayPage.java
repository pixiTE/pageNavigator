...
public class MondayPage extends WebPage {
    ...
    private void loadDay() {
        day = new Model<Day>(dayService.findByType(DayType.MONDAY));
    }
    ...
    private void createPreviousButton(Form<?> form) {
        Button start = new Button("previous") {
            ...
            private Class previousPage() {
                return stepManager.getPreviousPage(DayType.MONDAY);
            }
        };
        form.add(start);
    }
    ...
    private void createNextButton(Form<?> form) {
        Button start = new Button("next") {
            ...
            @Override
            public void onSubmit() {
                setResponsePage(stepManager.getNextPage(DayType.MONDAY));
            }
        };
        form.add(start);
    }
