...
public class FridayPage extends WebPage {
    ...
    private void loadDay() {
        day = new Model<Day>(dayService.findByType(DayType.FRIDAY));
    }
    ...
    private void createPreviousButton(Form<?> form) {
        Button start = new Button("previous") {
            ...
            public void onSubmit() {
                setResponsePage(stepManager.getPreviousPage(DayType.FRIDAY));
    ...
    private void createNextButton(Form<?> form) {
        Button start = new Button("next") {
            ...
            @Override
            public void onSubmit() {
                setResponsePage(stepManager.getNextPage(DayType.FRIDAY));
            }
        };
        form.add(start);
    }
