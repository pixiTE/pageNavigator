...
public class TuesdayPage extends WebPage {
    ...
    private void loadDay() {
        day = new Model<Day>(dayService.findByType(DayType.TUESDAY));
    }
    ...
    private void createPreviousButton(Form<?> form) {
        Button start = new Button("previous") {
            ...
            public void onSubmit() {
                setResponsePage(stepManager.getPreviousPage(DayType.TUESDAY));
    ...
    private void createNextButton(Form<?> form) {
        Button start = new Button("next") {
            ...
            @Override
            public void onSubmit() {
                setResponsePage(stepManager.getNextPage(DayType.TUESDAY));
            }
        };
        form.add(start);
    }
