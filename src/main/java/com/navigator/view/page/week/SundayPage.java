...
public class SundayPage extends WebPage {
    ...
    private void loadDay() {
        day = new Model<Day>(dayService.findByType(DayType.SUNDAY));
    }
    ...
    private void createPreviousButton(Form<?> form) {
        Button start = new Button("previous") {
            ...
            public void onSubmit() {
                setResponsePage(stepManager.getPreviousPage(DayType.SUNDAY));
    ...
    private void createNextButton(Form<?> form) {
        Button start = new Button("next") {
            ...
            @Override
            public void onSubmit() {
                setResponsePage(stepManager.getNextPage(DayType.SUNDAY));
            }
        };
        form.add(start);
    }
