...
public class ThursdayPage extends WebPage {
    ...
    private void loadDay() {
        day = new Model<Day>(dayService.findByType(DayType.THURSDAY));
    }
    ...
    private void createPreviousButton(Form<?> form) {
        Button start = new Button("previous") {
            ...
            public void onSubmit() {
                setResponsePage(stepManager.getPreviousPage(DayType.THURSDAY));
    ...
    private void createNextButton(Form<?> form) {
        Button start = new Button("next") {
            ...
            @Override
            public void onSubmit() {
                setResponsePage(stepManager.getNextPage(DayType.THURSDAY));
            }
        };
        form.add(start);
    }
