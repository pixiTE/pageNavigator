...
public class WednesdayPage extends WebPage {
    ...
    private void loadDay() {
        day = new Model<Day>(dayService.findByType(DayType.WEDNESDAY));
    }
    ...
    private void createPreviousButton(Form<?> form) {
        Button start = new Button("previous") {
            ...
            public void onSubmit() {
                setResponsePage(stepManager.getPreviousPage(DayType.WEDNESDAY));
    ...
    private void createNextButton(Form<?> form) {
        Button start = new Button("next") {
            ...
            @Override
            public void onSubmit() {
                setResponsePage(stepManager.getNextPage(DayType.WEDNESDAY));
            }
        };
        form.add(start);
    }
